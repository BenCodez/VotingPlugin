Warning: truncated output (original token count: 36282)
			...
			public void execute(CommandSender sender, String[] args) {
				...
				plugin.getBukkitScheduler().runTaskAsynchronously(plugin, new Runnable() {
					...
					public void run() {
						...
						final Updater.UpdateRes…6282 tokens truncated…atabase of offline UUIDs, keeps online UUIDs", true, true) {
